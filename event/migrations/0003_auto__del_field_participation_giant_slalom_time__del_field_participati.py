...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Participation.giant_slalom_time'
        db.delete_column('event_participation', 'giant_slalom_time')

        # Deleting field 'Participation.cross_country_time'
        db.delete_column('event_participation', 'cross_country_time')

        # Deleting field 'Participation.swimming_time'
        db.delete_column('event_participation', 'swimming_time')

        # Adding field 'Participation.giant_slalom_time_minutes'
        db.add_column('event_participation', 'giant_slalom_time_minutes',
                      self.gf('django.db.models.fields.IntegerField')(default=None, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Participation.giant_slalom_time_seconds'
        db.add_column('event_participation', 'giant_slalom_time_seconds',
                      self.gf('django.db.models.fields.IntegerField')(default=None, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Participation.giant_slalom_time_hundredths'
        db.add_column('event_participation', 'giant_slalom_time_hundredths',
                      self.gf('django.db.models.fields.IntegerField')(default=None, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Participation.cross_country_time_minutes'
        db.add_column('event_participation', 'cross_country_time_minutes',
                      self.gf('django.db.models.fields.IntegerField')(default=None, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Participation.cross_country_time_seconds'
        db.add_column('event_participation', 'cross_country_time_seconds',
                      self.gf('django.db.models.fields.IntegerField')(default=None, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Participation.cross_country_time_hundredths'
        db.add_column('event_participation', 'cross_country_time_hundredths',
                      self.gf('django.db.models.fields.IntegerField')(default=None, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Participation.swimming_time_minutes'
        db.add_column('event_participation', 'swimming_time_minutes',
                      self.gf('django.db.models.fields.IntegerField')(default=None, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Participation.swimming_time_seconds'
        db.add_column('event_participation', 'swimming_time_seconds',
                      self.gf('django.db.models.fields.IntegerField')(default=None, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Participation.swimming_time_hundredths'
        db.add_column('event_participation', 'swimming_time_hundredths',
                      self.gf('django.db.models.fields.IntegerField')(default=None, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Participation.giant_slalom_time'
        db.add_column('event_participation', 'giant_slalom_time',
                      self.gf('django.db.models.fields.TimeField')(default=None, null=True),
                      keep_default=False)

        # Adding field 'Participation.cross_country_time'
        db.add_column('event_participation', 'cross_country_time',
                      self.gf('django.db.models.fields.TimeField')(default=None, null=True),
                      keep_default=False)

        # Adding field 'Participation.swimming_time'
        db.add_column('event_participation', 'swimming_time',
                      self.gf('django.db.models.fields.TimeField')(default=None, null=True),
                      keep_default=False)

        # Deleting field 'Participation.giant_slalom_time_minutes'
        db.delete_column('event_participation', 'giant_slalom_time_minutes')

        # Deleting field 'Participation.giant_slalom_time_seconds'
        db.delete_column('event_participation', 'giant_slalom_time_seconds')

        # Deleting field 'Participation.giant_slalom_time_hundredths'
        db.delete_column('event_participation', 'giant_slalom_time_hundredths')

        # Deleting field 'Participation.cross_country_time_minutes'
        db.delete_column('event_participation', 'cross_country_time_minutes')

        # Deleting field 'Participation.cross_country_time_seconds'
        db.delete_column('event_participation', 'cross_country_time_seconds')

        # Deleting field 'Participation.cross_country_time_hundredths'
        db.delete_column('event_participation', 'cross_country_time_hundredths')

        # Deleting field 'Participation.swimming_time_minutes'
        db.delete_column('event_participation', 'swimming_time_minutes')

        # Deleting field 'Participation.swimming_time_seconds'
        db.delete_column('event_participation', 'swimming_time_seconds')

        # Deleting field 'Participation.swimming_time_hundredths'
        db.delete_column('event_participation', 'swimming_time_hundredths')
    ...
    models = {
        ...
        'event.participation': {
            ...
            'startnumber': ('django.db.models.fields.IntegerField', [], {'blank': 'True'}),
